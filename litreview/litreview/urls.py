...
urlpatterns = [
    ...
    path(
        "create_review_to_ticket/<int:ticket_id>/",
        feed.views.create_review_to_ticket,
    ...
    path(
        "delete_review/<int:review_id>/", feed.views.delete_review, name="delete_review"
    ),
    path("edit_ticket/<int:ticket_id>/", feed.views.edit_ticket, name="edit_ticket"),
    path(
        "delete_ticket/<int:ticket_id>/", feed.views.delete_ticket, name="delete_ticket"
    ),
]
